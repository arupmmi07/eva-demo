...
export const SC7_SCHEDULE_CHANGES =
  "Schedule Changes: Two cancellations had come in over the weekend on Dr. Park's schedule. Both of them have already been filled - one returning patient, one new. One flag: John Smith is only forty percent through their digital patient intake. Not a problem yet. If they arrived without finishing, I would let you know before they reach the desk. Anything else I can let you know, Maya?";
